...
package net.gabuchan.androidrecipe.recipe079;
...
public class Recipe079Activity extends Activity {
    ...
    private PictureCallback mPictureCallback = new PictureCallback() {
        ...
        public void onPictureTaken(byte[] data, Camera camera) {
            ...
            try {
                ...
                // スキャンさせる（ギャラリーに反映が目的）
                MediaScannerConnection.scanFile(Recipe079Activity.this, new String[] {
                        file.toString()
                }, null, null);
    ...
    private AutoFocusCallback mAutoFocusCallback = new AutoFocusCallback() {
        ...
        public void onAutoFocus(boolean success, Camera camera) {
            if (success) {
                showToast("オートフォーカス成功！");
            } else {
                showToast("オートフォーカス失敗！");
            }
        }
    };
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_recipe_079);
